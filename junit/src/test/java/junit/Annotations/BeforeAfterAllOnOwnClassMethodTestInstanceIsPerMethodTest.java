...
public class BeforeAfterAllOnOwnClassMethodTestInstanceIsPerMethodTest {
	
	//---------------- For Own Class Method in Before All, AfterAll if Test Instance in set to PER METHOD, we need to set the method as STATIC
	@BeforeAll
